...
export class RecipesFetchService {
  ...
  private _recipeList: Irecipe[] = [
    {
      ...
      ingredients:[{IngredientName:"Flour",quantity:2},{IngredientName:"Butter",quantity:5}]
    },
    {
      id:2,
      name:"Paneer Tikka",
      ...
      ingredients:[{IngredientName:"Paneer",quantity:20},{IngredientName:"Tomato",quantity:7},{IngredientName:"Onion",quantity:5}]
    },
    {
      id:3,
      name:"Khandavi",
    ...
    },
    {
      ...
      ingredients:[{IngredientName:"Rice",quantity:1},{IngredientName:"Vegetables",quantity:5}]
    },
    {
      id:5,
      ...
      ingredients:[{IngredientName:"Daal",quantity:1},{IngredientName:"Tomato",quantity:5}]
    },
  ]
  constructor() { }
  ...
  addNewRecipe(recipe: Irecipe){
    ...
    console.log("RecipeList original", this._recipeList);
  }
  editRecipe(Erecipe: Irecipe) {
    this._recipeList.map(recipe =>{
    if(recipe.id === Erecipe.id)
      {
        this._recipeList[recipe.id-1] = Erecipe;
        console.log("RecipeList original", this._recipeList);
      }
    })
  }
  ...
  deleteRecipe(id:number){
    this._recipeList.splice(id-1,1);
    console.log("RecipeList original", this._recipeList);
  }
